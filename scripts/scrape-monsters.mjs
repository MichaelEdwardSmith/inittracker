...
const SLUGS = [
  'aarakocra-aeromancer','aarakocra-skirmisher','aberrant-cultist','aberrant-spirit',
  'aboleth','abominable-yeti','adult-black-dragon','adult-blue-dragon','adult-brass-dragon',
  ...
  'ancient-silver-dragon','ancient-white-dragon','animal-lord','animated-armor','animated-broom',
  'animated-flying-sword','animated-object','animated-rug-of-smothering','ankheg','ankylosaurus',
  'ape','arcanaloth','arch-hag','archelon','archmage','archpriest','assassin','awakened-shrub',
  'awakened-tree','axe-beak','azer-pyromancer','azer-sentinel','baboon','badger','balor',
  'bandit','bandit-captain','bandit-crime-lord','bandit-deceiver','banshee','barbed-devil',
  'barlgura','basilisk','bat','bearded-devil','beast-of-the-land','beast-of-the-sea',
  'beast-of-the-sky','behir','beholder','beholder-zombie','berserker','berserker-commander',
  'bestial-spirit','black-bear','black-dragon-wyrmling','black-pudding','blink-dog',
  'blob-of-annihilation','blood-hawk','blue-dragon-wyrmling','blue-slaad','boar','bone-devil',
  'bone-naga','brass-dragon-wyrmling','brazen-gorgon','bronze-dragon-wyrmling','brown-bear',
  'bugbear-stalker','bugbear-warrior','bulette','bulette-pup','bullywug-bog-sage',
  'bullywug-warrior','cambion','camel','carrion-crawler','cat','celestial-spirit',
  'centaur-trooper','centaur-warden','chain-devil','chasme','chimera','chuul','clay-golem',
  'cloaker','cloud-giant','cockatrice','cockatrice-regent','colossus','commoner',
  'constrictor-snake','construct-spirit','copper-dragon-wyrmling','couatl','crab',
  'crawling-claw','crocodile','cultist','cultist-fanatic','cultist-hierophant','cyclops-oracle',
  'cyclops-sentry','dao','darkmantle','death-cultist','death-dog','death-knight',
  'death-knight-aspirant','death-slaad','death-tyrant','deer','demilich','deva','dire-wolf',
  'dire-worg','displacer-beast','djinni','doppelganger','dracolich','draconic-spirit',
  'draft-horse','dragon-turtle','dretch','drider','druid','dryad','dust-mephit','eagle',
  'earth-elemental','efreeti','elemental-cataclysm','elemental-cultist','elemental-spirit',
  'elephant','elk','empyrean','empyrean-iota','erinyes','ettercap','ettin','faerie-dragon-adult',
  'faerie-dragon-youth','fey-spirit','fiend-cultist','fiendish-spirit','fire-elemental',
  'fire-giant','flameskull','flaming-skeleton','flesh-golem','flumph','flying-snake','fomorian',
  'frog','frost-giant','galeb-duhr','gargoyle','gas-spore-fungus','gelatinous-cube','ghast',
  'ghast-gravecaller','ghost','ghoul','giant-ape','giant-axe-beak','giant-badger','giant-bat',
  ...
  'giant-insect','giant-lizard','giant-octopus','giant-owl','giant-rat','giant-scorpion',
  'giant-seahorse','giant-shark','giant-spider','giant-squid','giant-toad',
  'giant-venomous-snake','giant-vulture','giant-wasp','giant-weasel','giant-wolf-spider',
  'gibbering-mouther','githyanki-dracomancer','githyanki-knight','githyanki-warrior',
  'githzerai-monk','githzerai-psion','githzerai-zerth','glabrezu','gladiator','gnoll-demoniac',
  'gnoll-fang-of-yeenoghu','gnoll-pack-lord','gnoll-warrior','goat','goblin-boss',
  'goblin-hexer','goblin-minion','goblin-warrior','gold-dragon-wyrmling','gorgon','goristro',
  'graveyard-revenant','gray-ooze','gray-slaad','green-dragon-wyrmling','green-hag',
  'green-slaad','grell','grick','grick-ancient','griffon','grimlock','guard','guard-captain',
  'guardian-naga','gulthias-blight','half-dragon','harpy','haunting-revenant','hawk',
  'hell-hound','helmed-horror','hezrou','hill-giant','hippogriff','hippopotamus',
  'hobgoblin-captain','hobgoblin-warlord','hobgoblin-warrior','homunculus','hook-horror',
  'horned-devil','hunter-shark','hydra','hyena','ice-devil','ice-mephit','imp','incubus',
  'intellect-devourer','invisible-stalker','iron-golem','jackal','jackalwere',
  'juvenile-shadow-dragon','kenku','killer-whale','knight','kobold-warrior','kraken','kuo-toa',
  'kuo-toa-archpriest','kuo-toa-monitor','kuo-toa-whip','lacedon-ghoul','lamia','larva',
  'lemure','lich','lion','lizard','lizardfolk-geomancer','lizardfolk-sovereign','mage',
  'mage-apprentice','magma-mephit','magmin','mammoth','manes','manes-vaporspawn','manticore',
  'marid','marilith','mastiff','medusa','merfolk-skirmisher','merfolk-wavebender','merrow',
  'mezzoloth','mimic','mind-flayer','mind-flayer-arcanist','minotaur-of-baphomet',
  'minotaur-skeleton','mud-mephit','mule','mummy','mummy-lord','myconid-adult',
  'myconid-sovereign','myconid-spore-servant','myconid-sprout','nalfeshnee','needle-blight',
  'night-hag','nightmare','noble','noble-prodigy','nothic','nycaloth','ochre-jelly','octopus',
  'ogre','ogre-zombie','ogrillon-ogre','oni','otherworldly-steed','otyugh','owl','owlbear',
  'panther','pegasus','performer','performer-legend','performer-maestro','peryton',
  'phase-spider','piercer','piranha','pirate','pirate-admiral','pirate-captain','pit-fiend',
  'pixie','pixie-wonderbringer','planetar','plesiosaurus','polar-bear','poltergeist','pony',
  'priest','priest-acolyte','primeval-owlbear','pseudodragon','psychic-gray-ooze','pteranodon',
  'purple-worm','quaggoth','quaggoth-thonot','quasit','questing-knight','rakshasa','rat',
  'raven','red-dragon-wyrmling','red-slaad','reef-shark','remorhaz','revenant','rhinoceros',
  'riding-horse','roc','roper','rust-monster','saber-toothed-tiger','sahuagin-baron',
  'sahuagin-priest','sahuagin-warrior','salamander','salamander-fire-snake',
  'salamander-inferno-master','satyr','satyr-revelmaster','scarecrow','scorpion','scout',
  'scout-captain','sea-hag','seahorse','shadow','shadow-dragon','shambling-mound',
  'shield-guardian','shrieker-fungus','silver-dragon-wyrmling','skeleton','slaad-tadpole',
  'smoke-mephit','solar','spectator','specter','sphinx-of-lore','sphinx-of-secrets',
  'sphinx-of-valor','sphinx-of-wonder','spider','spined-devil','spirit-naga','sprite','spy',
  'spy-master','steam-mephit','stirge','stone-giant','stone-golem','storm-giant','succubus',
  'swarm-of-bats','swarm-of-crawling-claws','swarm-of-dretches','swarm-of-insects',
  'swarm-of-larvae','swarm-of-lemures','swarm-of-piranhas','swarm-of-rats','swarm-of-ravens',
  'swarm-of-stirges','swarm-of-venomous-snakes','tarrasque','thri-kreen-marauder',
  'thri-kreen-psion','tiger','tough','tough-boss','treant','tree-blight','triceratops',
  'troglodyte','troll','troll-limb','twig-blight','tyrannosaurus-rex','ultroloth','umber-hulk',
  'undead-spirit','unicorn','vampire','vampire-familiar','vampire-nightbringer','vampire-spawn',
  'vampire-umbral-lord','venomous-snake','vine-blight','violet-fungus','violet-fungus-necrohulk',
  'vrock','vulture','warhorse','warhorse-skeleton','warrior-commander','warrior-infantry',
  'warrior-veteran','water-elemental','water-weird','weasel','werebear','wereboar','wererat',
  'weretiger','werewolf','white-dragon-wyrmling','wight','will-o--wisp','winged-kobold',
  'winter-wolf','wolf','worg','wraith','wyvern','xorn','yeti','yochlol','young-black-dragon',
  'young-blue-dragon','young-brass-dragon','young-bronze-dragon','young-copper-dragon',
  'young-gold-dragon','young-green-dragon','young-red-dragon','young-remorhaz',
  'young-silver-dragon','young-white-dragon','yuan-ti-abomination','yuan-ti-infiltrator',
  'yuan-ti-malison-type-1','yuan-ti-malison-type-2','yuan-ti-malison-type-3','zombie',
];
...
function stripTags(html) {
  return html.replace(/<[^>]+>/g, '').replace(/&amp;/g, '&').replace(/&lt;/g, '<')
    ...
    .replace(/&raquo;/g, '»').replace(/\s+/g, ' ').trim();
}
...
function parseMonsterHtml(html, slug) {
  ...
  const typeMatch = typeLine.match(/^(Fine|Diminutive|Tiny|Small|Medium|Large|Huge|Gargantuan)\s+(.+?),\s*(.+)$/i);
