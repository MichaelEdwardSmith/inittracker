		...
		{:else}
			<div class="flex flex-col gap-4 px-5 py-5">
				<div class="flex flex-col gap-1.5">
					<label for="msg-from" class="text-xs font-semibold tracking-wider text-gray-500 uppercase"
						>Sending as</label
					>
					<select
						id="msg-from"
				...
				<div class="flex flex-col gap-1.5">
					<label for="msg-text" class="text-xs font-semibold tracking-wider text-gray-500 uppercase"
						>Message</label
					>
					<textarea
						id="msg-text"
