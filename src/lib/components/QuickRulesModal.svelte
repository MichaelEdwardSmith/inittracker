...
<script lang="ts">
	...
	const magicItems: MagicItem[] = [
		// ARMOR
		{
			...
			cost: '500 gp',
			description:
				'Suit of armor made from adamantine. While wearing it, any critical hit against you becomes a normal hit.'
		},
		{
		...
		},
		{
			...
			cost: '1,500 gp',
			description:
				'You have resistance to one type of damage while you wear this armor. The DM chooses the type or determines it randomly from: acid, cold, fire, force, lightning, necrotic, poison, psychic, radiant, or thunder.'
		},
		{
		...
		},
		{
			...
			cost: '1,500 gp',
			description:
				'While holding this shield, you have resistance to damage from ranged weapon attacks. Curse: This shield is cursed. Attuning to it curses you until you are targeted by the remove curse spell or similar magic. Whenever a ranged weapon attack is made against a target within 10 feet of you, the curse causes you to become the target instead.'
		},
		{
		...
		},
		{
			...
			cost: '1,000 gp',
			description:
				'When you drink this potion, you gain the "reduce" effect of the enlarge/reduce spell for 1d4 hours (no concentration required). The red in the potion\'s liquid continuously contracts to a tiny bead and then expands again to color the clear liquid around it.'
		},
		{
		...
		},
		{
			...
			cost: '300 gp',
			description:
				'When you drink this potion, you gain resistance to one type of damage for 1 hour. The DM chooses the type or determines it randomly.'
		},
		{
		...
		},
		{
			...
			cost: '200 gp',
			description:
				"When you drink this potion, your Strength score changes to 21 for 1 hour. If your Strength is equal to or greater than 21, the potion has no effect. The Giant's type determines the Strength score. Hill Giant: 21."
		},
		{
			...
			cost: '1,000 gp',
			description:
				'When you drink this potion, your Strength score changes to 23 for 1 hour (Stone or Frost Giant). If your Strength is already 23 or higher, the potion has no effect.'
		},
		{
			...
			cost: '1,200 gp',
			description:
				'When you drink this potion, your Strength score changes to 25 for 1 hour (Fire Giant). If your Strength is already 25 or higher, the potion has no effect.'
		},
		{
			...
			cost: '5,000 gp',
			description:
				'When you drink this potion, your Strength score changes to 27 for 1 hour (Cloud Giant). If your Strength is already 27 or higher, the potion has no effect.'
		},
		{
			...
			cost: '50,000 gp',
			description:
				'When you drink this potion, your Strength score changes to 29 for 1 hour (Storm Giant). If your Strength is already 29 or higher, the potion has no effect.'
		},
		{
		...
		},
		{
			...
			cost: '75,000 gp',
			description:
				'While wearing this ring, you can turn invisible as an action. Anything you wear or carry is invisible with you. You remain invisible until the ring is removed, until you attack or cast a spell, or until you use a bonus action to become visible again.'
		},
		{
		...
		},
		{
			...
			cost: '15,000 gp',
			description:
				'While wearing this ring in dim light or darkness, you can cast dancing lights and light from the ring at will. Casting either spell is an action. The ring has 6 charges for the following other properties. The ring regains 1d6 expended charges daily at dawn.'
		},
		{
		...
		},
		{
			...
			cost: '4,000 gp',
			description:
				"This ring has 3 charges, and it regains 1d3 expended charges daily at dawn. While wearing the ring, you can use an action to expend 1 to 3 of its charges to attack one creature you can see within 60 feet of you. The ring produces a spectral ram's head and makes its attack roll with a +7 bonus."
		},
		{
			name: 'Ring of Warmth',
			source: 'DMG',
		...
		},
		{
			...
			cost: '12,000 gp',
			description:
				"While holding this rod, you can use your reaction to absorb a spell that is targeting only you and not with an area of effect. The absorbed spell's effect is canceled, and the spell's energy—not the spell itself—is stored in the rod. The energy has the same level as the spell when it was cast."
		},
		{
			...
			cost: '12,000 gp',
			description:
				'This rod has a flanged head and the following properties. While holding the rod, you have advantage on Wisdom (Perception) checks and on rolls for initiative. The rod also functions as a magic weapon with a +1 bonus to attack rolls and damage rolls.'
		},
		{
			...
			cost: '70,000 gp',
			description:
				'This rod functions as a magic mace that grants a +3 bonus to attack and damage rolls made with it. The rod has properties associated with six different buttons that are set in a row along the haft.'
		},
		{
		...
		},
		{
			...
			cost: '12,000 gp',
			description:
				'While holding this rod, you can use an action to activate it. The rod then instantly transports you and up to 199 other willing creatures you can see to a paradise that exists in an extraplanar space. This paradise can be a garden, a glade, an island, a palatial suite, or some other place of great beauty.'
		},
		{
		...
		},
		{
			...
			cost: '2,000 gp',
			description:
				'While holding this rod, you gain a +2 bonus to spell attack rolls and to the saving throw DCs of your warlock spells. In addition, you can regain one warlock spell slot as an action while holding the rod.'
		},
		{
			...
			cost: '10,000 gp',
			description:
				'While holding this rod, you gain a +3 bonus to spell attack rolls and to the saving throw DCs of your warlock spells. In addition, you can regain one warlock spell slot as an action while holding the rod.'
		},
		// STAFFS
		{
			...
			type: 'Staff',
			rarity: 'Rare',
			attunement: 'Yes (Bard/Cleric/Druid/Sorcerer/Warlock/Wizard)',
			cost: '4,000 gp',
			description:
				'While holding this staff, you can use an action to expend 1 of its 10 charges to cast charm person, command, or comprehend languages from it using your spell save DC. The staff can also be used as a magic quarterstaff. The staff regains 1d8 + 2 expended charges daily at dawn.'
		},
		{
			name: 'Staff of Fire',
			source: 'DMG',
			...
			type: 'Staff',
			rarity: 'Very Rare',
			attunement: 'Yes (Druid/Sorcerer/Warlock/Wizard)',
			cost: '12,000 gp',
			description:
				'You have resistance to fire damage while you hold this staff. The staff has 10 charges. While holding it, you can use an action to expend 1 or more of its charges to cast one of the following spells from it, using your spell save DC: burning hands (1 charge), fireball (3 charges), wall of fire (4 charges).'
		},
		{
			name: 'Staff of Frost',
			source: 'DMG',
		...
		},
		{
			...
			type: 'Staff',
			rarity: 'Rare',
			attunement: 'Yes (Bard/Cleric/Druid)',
			cost: '4,000 gp',
			description:
		...
		},
		{
			...
			type: 'Staff',
			rarity: 'Very Rare',
			attunement: 'Yes (Sorcerer/Warlock/Wizard)',
			cost: '18,000 gp',
			description:
				'This staff can be wielded as a magic quarterstaff that grants a +2 bonus to attack and damage rolls. While holding it, you gain a +2 bonus to Armor Class, saving throws, and spell attack rolls. The staff has 20 charges for the following properties. The staff regains 2d8 + 4 expended charges daily at dawn.'
		},
		{
			...
			cost: '15,000 gp',
			description:
				'This staff can be wielded as a magic quarterstaff that grants a +3 bonus to attack and damage rolls. The staff has 10 charges. When you hit with a melee attack using it, you can expend up to 3 of its charges. For each charge you expend, the target takes an extra 1d6 force damage.'
		},
		{
			...
			type: 'Staff',
			rarity: 'Rare',
			attunement: 'Yes (Bard/Cleric/Druid/Shaman/Warlock/Wizard)',
			cost: '4,000 gp',
			description:
				'This staff has 10 charges and regains 1d6 + 4 expended charges daily at dawn. While holding the staff, you can use an action to expend some of its charges to cast one of the following spells from it, using your spell save DC: giant insect (4 charges) or insect plague (5 charges).'
		},
		{
			...
			cost: '95,000 gp',
			description:
				'This staff can be wielded as a magic quarterstaff that grants a +2 bonus to attack and damage rolls. While you hold it, you gain a +2 bonus to spell attack rolls. The staff has 50 charges for the following properties. It regains 4d6 + 2 expended charges daily at dawn.'
		},
		{
			...
			type: 'Staff',
			rarity: 'Uncommon',
			attunement: 'Yes (Cleric/Druid/Warlock)',
			cost: '400 gp',
			description:
		...
		},
		{
			...
			type: 'Staff',
			rarity: 'Rare',
			attunement: 'Yes (Druid)',
			cost: '4,500 gp',
			description:
				'This staff can be wielded as a magic quarterstaff that grants a +2 bonus to attack and damage rolls. While holding it, you have a +2 bonus to spell attack rolls. The staff has 10 charges for the following properties. It regains 1d6 + 4 expended charges daily at dawn.'
		},
		{
			...
			cost: '12,000 gp',
			description:
				"This staff can be wielded as a magic quarterstaff that grants a +2 bonus to attack and damage rolls. It also has the following additional properties. When one of these properties is used, it can't be used again until the next dawn: Lightning, Thunder, Lightning Strike, Thunderclap, Thunder and Lightning."
		},
		{
		...
		},
		{
			...
			cost: '3,000 gp',
			description:
				'This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cause a thin blue ray to streak from the tip toward a creature you can see within 60 feet of you. The target must succeed on a DC 15 Constitution saving throw or be paralyzed for 1 minute. The wand regains 1d6 + 1 expended charges daily at dawn.'
		},
		{
			...
			cost: '8,000 gp',
			description:
				'This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the polymorph spell (save DC 15) from it. The wand regains 1d6 + 1 expended charges daily at dawn.'
		},
		{
		...
		},
		{
			...
			cost: '400 gp',
			description:
				'This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges to cast the web spell (save DC 15) from it. The wand regains 1d6 + 1 expended charges daily at dawn.'
		},
		{
			name: 'Wand of Wonder',
			source: 'DMG',
		...
		// WEAPONS
		{
			...
			cost: '600 gp',
			description:
				'An arrow of slaying is a magic weapon meant to kill a particular kind of creature. The DM chooses the type or determines it randomly. If a creature belonging to the type associated with an arrow of slaying takes damage from the arrow, the creature must make a DC 17 Constitution saving throw, taking an extra 6d10 piercing damage on a failed save, or half as much extra damage on a successful one.'
		},
		{
			name: 'Berserker Axe',
			source: 'DMG',
		...
		},
		{
			...
			cost: '2,000 gp',
			description:
				"You gain a +1 bonus to attack and damage rolls made with this magic weapon. When you hit a giant with it, the giant takes an extra 2d6 damage of the weapon's type and must succeed on a DC 15 Strength saving throw or fall prone."
		},
		{
		...
		},
		{
			...
			cost: '500 gp',
			description:
				'This javelin is a magic weapon. When you hurl it and speak its command word, it transforms into a bolt of lightning, forming a line 5 feet wide that extends out from you to a target within 120 feet of you. Each creature in the line excluding you and the target must make a DC 13 Dexterity saving throw, taking 4d6 lightning damage on a failed save, and half as much damage on a successful one. The lightning bolt turns back into a javelin when it reaches the target. Make a ranged weapon attack against the target. On a hit, the target takes damage from the javelin plus 4d6 lightning damage.'
		},
		{
			name: 'Luck Blade',
			source: 'DMG',
		...
		},
		{
			...
			cost: '10,000 gp',
			description:
				'When you nock an arrow on this bow, it whispers in Elvish, "Swift defeat to my enemies." When you use this weapon to attack your sworn enemy, you have advantage on the attack roll. In addition, your target gains no benefit from cover, other than total cover, and you suffer no disadvantage due to long range.'
		},
		{
		...
		},
		{
			...
			cost: '400 gp',
			description:
				'This magic weapon has 3 charges. While you carry it, you can use an action and expend 1 charge to cast dominate beast (save DC 15) from it on a beast that has an innate swimming speed. The trident regains 1d3 expended charges daily at dawn.'
		},
		{
			name: 'Vicious Weapon',
			source: 'DMG',
		...
		},
		{
			...
			cost: '— gp',
			description:
				'This bag superficially resembles a bag of holding but is a feeding orifice for a gigantic extradimensional creature. Placing an object in the bag causes the bag to attempt to swallow it. A creature that places a limb into the bag is subjected to a mouth attack (+8 to hit) dealing 3d6 piercing damage.'
		},
		{
			name: 'Bag of Holding',
			source: 'DMG',
		...
		},
		{
			...
			cost: '16,000 gp',
			description:
				'While wearing this belt, your Strength score changes to 23 (Stone or Frost Giant strength).'
		},
		{
			...
			cost: '20,000 gp',
			description:
				'While wearing this belt, your Strength score changes to 25 (Fire Giant strength).'
		},
		{
			...
			cost: '80,000 gp',
			description:
				'While wearing this belt, your Strength score changes to 27 (Cloud Giant strength).'
		},
		{
			...
			cost: '200,000 gp',
			description:
				'While wearing this belt, your Strength score changes to 29 (Storm Giant strength).'
		},
		{
		...
		},
		{
			...
			cost: '3,000 gp',
			description:
				"While you wear these boots, you can use a bonus action and click the boots' heels together to double your walking speed. When you use this feature, difficult terrain doesn't cost you extra movement. You can end this effect as a bonus action. The effect ends after 10 minutes."
		},
		{
		...
		},
		{
			...
			cost: '300 gp',
			description:
				'These furred boots are snug and feel quite warm. While you wear them, you gain the following benefits: You have resistance to cold damage. You ignore difficult terrain created by ice or snow. You can tolerate temperatures as low as −50 degrees Fahrenheit without any additional protection.'
		},
		{
		...
		},
		{
			...
			cost: '300 gp',
			description:
				"While wearing this circlet, you can use an action to cast the scorching ray spell with it. When you make the spell's attacks, you do so with an attack bonus of +5. The property can't be used again until the next dawn."
		},
		{
		...
		},
		{
			...
			cost: '50,000 gp',
			description:
				'This crystal ball is about 6 inches in diameter. While touching it, you can cast the scrying spell (save DC 17) with it. The spell lasts for its normal duration. A crystal ball of telepathy or true seeing has additional properties depending on the type.'
		},
		{
			name: 'Cube of Force',
			source: 'DMG',
			...
			cost: '16,000 gp',
			description:
				"This cube is about an inch across. Each face has a distinct marking on it that can be pressed. The cube starts with 36 charges, and it regains 1d20 expended charges daily at dawn. You can use an action to press one of the cube's faces, expending a number of charges based on the chosen face."
		},
		{
		...
		},
		{
			...
			cost: '400 gp',
			description:
				'This stoppered flask sloshes when shaken, as if it contains water. The decanter weighs 2 pounds. You can use an action to remove the stopper and speak one of three command words, whereupon an amount of fresh water or salt water (your choice) pours out of the flask.'
		},
		{
		...
		},
		{
			...
			cost: '300 gp',
			description:
				'Found in a small packet, this powder resembles very fine sand. There is enough of it for one use. When you use an action to throw the dust into the air, you and each creature and object within 10 feet of you become invisible for 2d4 minutes. The duration is the same for all subjects, and the dust is consumed when its magic is activated.'
		},
		{
		...
		},
		{
			...
			cost: '200 gp',
			description:
				'Found in a small packet, this powder resembles very fine sand. It appears to be dust of disappearance, and an identify spell reveals it to be such. There is enough of it for one use. When you use an action to throw a handful of the dust into the air, you and each creature that needs to breathe within 30 feet of you must succeed on a DC 15 Constitution saving throw or become incapacitated for 1 minute due to uncontrollable sneezing.'
		},
		{
		...
		},
		{
			...
			cost: '16,000 gp',
			description:
				"When you use an action to remove the stopper, a cloud of thick smoke flows out of the bottle. At the end of your turn, the smoke disappears with a loud crack, and an efreeti appears in an unoccupied space within 30 feet of you. There is a 10 percent chance that the efreeti is hostile. If it isn't hostile, it is under your control for 1 hour."
		},
		{
			name: 'Elemental Gem',
			source: 'DMG',
			...
			cost: '300 gp',
			description:
				"This gem contains a mote of elemental energy. When you use an action to break the gem, an elemental is summoned as if you had cast the conjure elemental spell, and the gem's magic is lost. The type of gem determines the elemental summoned."
		},
		{
		...
		},
		{
			...
			cost: '4,500 gp',
			description:
				"You can use an action to speak the horn's command word and then blow the horn, which emits a thunderous blast in a 30-foot cone that is audible 600 feet away. Each creature in the cone must make a DC 15 Constitution saving throw. On a failed save, a creature takes 5d6 thunder damage and is deafened for 1 minute."
		},
		{
		...
		},
		{
			...
			cost: '18,000 gp',
			description:
				"When this 4-foot-tall mirror is activated, any creature other than you that sees its reflection must succeed on a DC 15 Charisma saving throw or be trapped, along with anything it is wearing or carrying, in one of the mirror's twelve extradimensional cells."
		},
		{
		...
		},
		{
			...
			type: 'Wondrous Item',
			rarity: 'Rare',
			attunement: 'Yes (Cleric/Druid/Paladin)',
			cost: '4,000 gp',
			description:
		...
		},
		{
			...
			cost: '400 gp',
			description:
				"While this pearl is on your person, you can use an action to speak its command word and regain one expended spell slot of up to 3rd level. Once you have used the pearl, it can't be used again until the next dawn."
		},
		{
		...
		},
		{
			...
			cost: '300 gp',
			description:
				'You must be proficient with wind instruments to use these pipes. While you play them, you can use a bonus action to attract rats, giant rats, or wererats within 1 mile of you and compel them to go to you.'
		},
		{
			name: 'Portable Hole',
			source: 'DMG',
		...
		},
		{
			...
			cost: '80,000 gp',
			description:
				'If you hold this beetle-shaped medallion in your hand for 1 round, an inscription appears on its surface revealing its magical nature. It provides two benefits while it is on your person: You have advantage on saving throws against spells. The scarab has 12 charges. If you fail a saving throw against a necromancy spell or a harmful effect originating from an undead creature, you can use your reaction to expend 1 charge and turn the failed save into a successful one.'
		},
		{
			name: 'Sending Stones',
			source: 'DMG',
		...
		},
		{
			...
			cost: '80,000 gp',
			description:
				"This fine black cloth, soft as silk, is folded up to the dimensions of a pocket handkerchief. It unfolds into a circular sheet 6 feet in diameter. You can use an action to unfold a well of many worlds and place it on or against a solid surface, whereupon it creates a two-way portal to a random location on a random plane of existence. Once opened, it can't be closed."
		},
		{
			name: 'Winged Boots',
			source: 'DMG',
		...
		// ARMOR
		{
			...
			cost: '75 gp',
			description:
				"This armor never gets dirty. Dust and grime slide off it, stains don't set, and it is always clean and bright."
		},
		{
			name: 'Cast-Off Armor',
			source: 'XGtE',
			...
			attunement: 'No',
			cost: '75 gp',
			description: 'You can doff this armor as an action, rather than the normal time required.'
		},
		{
			...
			cost: '75 gp',
			description:
				"The front of this shield is shaped in the likeness of a face. While bearing the shield, you can use a bonus action to alter the face's expression to show any emotion you choose (happiness, sadness, anger, etc.)."
		},
		{
			...
			cost: '75 gp',
			description:
				'Wisps of harmless, odorless smoke rise from this armor while it is worn. The smoke is not enough to obscure vision or create other effects.'
		},
		// STAFFS
		{
		...
		},
		{
			...
			cost: '75 gp',
			description:
				'This wooden staff has 10 charges. While holding it, you can use an action to expend 1 charge from the staff and cause a flower to sprout from a patch of earth or soil within 5 feet of you. The flower is harmless and nonmagical. The staff regains 1d6+4 expended charges daily at dawn.'
		},
		// WANDS
		{
			...
			cost: '75 gp',
			description:
				'This wand has 3 charges. While holding it, you can use an action to expend 1 of its charges and create orchestral music by waving it around. The music can be heard out to a range of 60 feet and lasts for 1 minute. The wand regains all expended charges daily at dawn.'
		},
		{
			...
			cost: '75 gp',
			description:
				'This wand has 7 charges. While holding it, you can use an action to expend 1 of its charges and produce a harmless burst of multicolored light from the tip of the wand. The burst is accompanied by a crackling noise that can be heard out to 300 feet. The wand regains 1d6+1 expended charges daily at dawn.'
		},
		{
			name: 'Wand of Scowls',
			source: 'XGtE',
		...
		},
		{
			...
			cost: '50 gp',
			description:
				'This spongy bead dissolves in liquid, transforming up to a pint of the liquid into fresh, cold drinking water. The bead has no effect on magical liquids or on liquids that are harmful in nature.'
		},
		{
		...
		},
		{
			...
			cost: '75 gp',
			description:
				'Whenever you roll this six-sided die, you can control which number it lands on. This is a six-sided die.'
		},
		{
		...
		},
		{
			...
			cost: '75 gp',
			description:
				"While wearing this cloak, you can use a bonus action to change the style, color, and apparent quality of the garment. The cloak's weight doesn't change. Regardless of its appearance, the cloak can't be anything but a cloak. Although it can duplicate the appearance of other magic cloaks, it doesn't duplicate their properties."
		},
		{
		...
		},
		{
			...
			cost: '75 gp',
			description:
				"This elegant outfit of traveler's clothes magically mends itself to counteract daily wear and tear. Pieces of the outfit that are separated from each other for more than a day lose the magic, and so are permanent holes, tears, and stains."
		},
		{
		...
		},
		{
			...
			cost: '75 gp',
			description:
				"While using this horn, you can't be deafened and you have advantage on Wisdom (Perception) checks that rely on hearing, as though you had the keen hearing trait."
		},
		{
			...
			cost: '75 gp',
			description:
				"This spellbook, along with anything written in it, can't be damaged by fire or immersion in water. In addition, the spellbook doesn't deteriorate with age."
		},
		{
			name: 'Ersatz Eye',
			source: 'XGtE',
		...
		},
		{
			...
			cost: '75 gp',
			description:
				'While holding this orb, you can use an action to determine what time of day it is. This property functions only on the Material Plane.'
		},
		{
		...
		},
		{
			...
			cost: '75 gp',
			description:
				'If you plant an ordinary shrub in this 10-pound clay pot and let it grow for 30 days, the shrub magically transforms into an awakened shrub at the end of that time. When the shrub awakens, its roots break the pot, destroying it. The awakened shrub is friendly to you and your companions.'
		},
		{
			...
			cost: '75 gp',
			description:
				'You can cut this 50-foot coil of hempen rope into any number of smaller pieces, and then use an action to speak a command word and cause the pieces to knit back together. The pieces must be in contact with each other and not otherwise in use. As long as the rope is one piece, it regains its full length.'
		},
		{
		...
		},
		{
			...
			cost: '75 gp',
			description:
				'This tankard has a stern face sculpted into one side. You can drink ale, wine, or any other nonmagical alcoholic beverage poured into it without becoming inebriated. The tankard has no effect on magical beverages or harmful substances such as poison.'
		},
		{
			name: "Veteran's Cane",
			source: 'XGtE',
		...
		},
		{
			...
			cost: '2,000 gp',
			description:
				'While holding this lyre, you can cast mending as a bonus action. You can also play the lyre as an action to cast fabricate, move earth, passwall, or summon construct spell, expending charges as necessary. The lyre regains charges at dawn. When you play it, you can also use it as a spellcasting focus for your bard spells.'
		},
		// WONDROUS ITEMS (Common)
		{
		...
		},
		{
			...
			cost: '75 gp',
			description:
				"While this tattoo is on your skin, you can use a bonus action to change the tattoo's color and pattern, and you can alter minor features of your appearance. Once altered, the changes remain until you alter them again. You can also use the tattoo to cast disguise self once per day, and the spell lasts for 1 hour."
		},
		{
		...
		// WONDROUS ITEMS (Uncommon)
		{
			...
			type: 'Wondrous Item',
			rarity: 'Uncommon',
			attunement: 'Yes (Artificer)',
			cost: '400 gp',
			description:
				"This simple screwdriver can transform into any type of artisan's tool you decide, changing shape and size as needed. You can use the tool as a spellcasting focus for your artificer spells. You gain a +1 bonus to spell attack rolls and to the saving throw DCs of your artificer spells. The bonus increases to +2 at Rare and +3 at Very Rare rarity."
		},
		{
			...
			cost: '400 gp',
			description:
				'You gain a +1 bonus to spell attack rolls and the saving throw DCs of your spells while you wear this amulet. You can use the amulet as a holy symbol. You gain 1 additional use of your Channel Divinity between rests while you wear this amulet. The bonus increases to +2 at Rare and +3 at Very Rare rarity.'
		},
		{
		...
		},
		{
			...
			cost: '400 gp',
			description:
				"While not wearing armor, this tattoo grants you an Armor Class of 12 plus your Dexterity modifier. At Rare rarity, your AC becomes 15 plus your Dexterity modifier. At Very Rare rarity, your AC becomes 18 (this version doesn't use your Dexterity modifier)."
		},
		{
			name: 'Bloodwell Vial',
			source: 'TCoE',
		...
		},
		{
			...
			cost: '400 gp',
			description:
				"This warm crystal glows with a soft golden light. While you hold the shard, you can use it as a spellcasting focus. When you use a Metamagic option while holding the shard, roll on the Wild Magic Surge table. If the result is a spell, it is too wild to be cast and doesn't happen, but note the number; a wild magic surge will occur the next time you cast a spell of 1st level or higher."
		},
		{
			...
			cost: '400 gp',
			description:
				"This emblem is the symbol of a deity or a spiritual tradition. While you wear this emblem, you can use your Channel Divinity feature to cast shield of faith on a creature as a bonus action instead of an action, and the spell's duration is 8 hours in this case. Once you use this property, it can't be used again until the next dawn."
		},
		{
		...
		},
		{
			...
			cost: '2,000 gp',
			description:
				"This crackling crystal comes in four varieties — air, earth, fire, and water — each containing a sliver of elemental power. When you use a Metamagic option while holding the shard, you gain a bonus effect depending on the shard's element: air (push a creature), earth (restrain a creature), fire (deal extra fire damage), or water (restore hit points)."
		},
		{
		...
		},
		{
			...
			cost: '2,000 gp',
			description:
				"While holding this concertina, you can use it as a spellcasting focus for your bard spells, and you gain a +2 bonus to the saving throw DCs of your bard spells. As an action, you can play the concertina to cast Otto's Irresistible Dance. Once this property is used, it can't be used again until the next dawn."
		},
		{
			...
			cost: '2,000 gp',
			description:
				"This tattoo is steeped in the gloom of the Shadowfell. While it is on your skin, you have darkvision out to 60 feet (or 30 feet more if you already have darkvision), and you have advantage on Dexterity (Stealth) checks. In addition, when you take damage, you can use your reaction to become partially incorporeal for a moment, halving the triggering damage. Once you use this reaction, it can't be used again until the next dawn."
		},
		{
			...
			cost: '2,000 gp',
			description:
				"This crystal is a sliver of the Shadowfell. While you hold the shard and use a Metamagic option, you can cast the hex spell on a creature you can see within 30 feet of you as a bonus action, without expending a spell slot or material components. Once you use this property, it can't be used again until the next dawn."
		},
		...
		},
		{
			...
			type: 'Wondrous Item',
			rarity: 'Very Rare',
			attunement: 'Yes (Druid/Warlock)',
			cost: '10,000 gp',
			description:
				"This Tiny pot bears relief images of skulls, bones, and beakers. Once per day, you can spend 1 minute to produce a potion of healing in the pot. While attuned to the cauldron and in contact with it, you can use it as a spellcasting focus. If a humanoid's corpse is placed in the cauldron and covered with 200 pounds of salt for 8 hours, the salt is consumed and the creature returns to life as if revivify had been cast on them."
		},
		{
		...
		},
		{
			...
			cost: '10,000 gp',
			description:
				"This tattoo depicts the cycle of life and death. While it is on your skin, you have resistance to necrotic damage. In addition, when you are reduced to 0 hit points, you can expend a use of the tattoo to drop to 1 hit point instead, as if you had the death ward spell active. Once you use this property, it can't be used again until the next dawn."
		},
		...
		},
		{
			...
			cost: '—',
			description:
				'This Artifact transforms into a mortar and pestle or a staff (as a bonus action). As a staff, it is a magic weapon that grants +3 to attack and damage. The mortar can be used to grind ingredients for a magical potion (1 hour). You can also use the artifact to travel up to 1,000 miles per day. The artifact has additional properties that can be discovered over time, and it has a random beneficial and detrimental effect while attuned.'
		},
		{
			name: 'Crook of Rao',
			source: 'TCoE',
		...
		},
		{
			...
			cost: '—',
			description:
				"Tasha's great work, this Artifact contains lore about demons and the Abyss. While attuned, you can use the book as a spellcasting focus. You can cast a number of demon-related spells without material components, including magic circle and summon greater demon. Any fiend that can see you must make a DC 20 Wisdom save or be frightened of you for 1 minute. The book also has detrimental random effects and is sought after by demons."
		},
		{
	...
	<div class="flex min-h-0 flex-1">
		...
		<div class="min-w-0 flex-1 overflow-y-auto px-8 py-6">
			...
			{:else if selected === 'exhaustion'}
				...
				{:else}
					<p class="mb-4 text-sm text-gray-300">
						Effects are cumulative. A long rest removes <strong class="text-white">one level</strong
						> of exhaustion (requires food and water).
					</p>
					<table class="w-full max-w-md text-sm">
						<thead>
							<tr class="border-b border-gray-700">
				...
				{#if ruleset === '2024'}
					<div class="space-y-5 text-sm">
						<p class="text-gray-300">
							2024 uses an <strong class="text-white">XP Budget</strong> system. Sum the XP of all monsters
							to get the encounter's total XP, then compare against the budget for your party size and
							desired difficulty. No multiplier.
						</p>
						<div>
				...
				<div class="flex h-full flex-col gap-4">
					...
					<div class="flex min-h-0 flex-1 gap-4">
						...
						<div class="w-72 shrink-0 overflow-y-auto rounded-xl border border-gray-800">
							{#each filteredMagicItems as item}
								<button
									...
									class="flex w-full flex-col gap-0.5 border-b border-gray-800 px-3 py-2.5 text-left transition hover:bg-gray-800 {selectedMagicItem?.name ===
									item.name
										? 'bg-amber-900/20'
										: ''}"
								>
									...
									<div class="flex items-center gap-2">
										...
										<span
											class="rounded px-1.5 py-0.5 text-[10px] font-bold {rarityColor[item.rarity]}"
											>{item.rarity}</span
										>
									</div>
								</button>
						...
						{#if selectedMagicItem}
							<div
								class="min-w-0 flex-1 overflow-y-auto rounded-xl border border-gray-800 bg-gray-900/50 p-5"
							>
								<div class="mb-3 flex flex-wrap items-baseline gap-3">
									<h4 class="text-xl font-black text-white">{selectedMagicItem.name}</h4>
									<span
										class="rounded px-2 py-0.5 text-xs font-bold {rarityColor[
											selectedMagicItem.rarity
										]}">{selectedMagicItem.rarity}</span
									>
								</div>
								<div class="mb-4 grid grid-cols-2 gap-x-6 gap-y-1.5 text-sm">
									<div>
										<span class="text-gray-400">Type: </span><span class="text-white"
											>{selectedMagicItem.type}</span
										>
									</div>
									<div>
										<span class="text-gray-400">Source: </span><span class="text-white"
											>{selectedMagicItem.source} p. {selectedMagicItem.page}</span
										>
									</div>
									<div>
										<span class="text-gray-400">Attunement: </span><span class="text-white"
											>{selectedMagicItem.attunement}</span
										>
									</div>
									<div>
										<span class="text-gray-400">Typical Cost: </span><span
											class="font-semibold text-amber-300">{selectedMagicItem.cost}</span
										>
									</div>
								</div>
						...
						{:else}
							<div
								class="flex flex-1 items-center justify-center rounded-xl border border-gray-800 text-gray-600"
							>
