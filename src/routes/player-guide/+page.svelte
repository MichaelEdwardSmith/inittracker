		...
		<main class="min-w-0 flex-1 space-y-16">
			...
			<section id="sound">
				...
				<p class="mb-4 text-sm leading-relaxed">
					...
					Sound requires you to tap <strong class="text-white">Join Session</strong> on first load
					(a browser requirement for audio autoplay).
				</p>

				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Toggling Sound</h3>
				<p class="mb-4 text-sm leading-relaxed">
					Open the <strong class="text-amber-300">☰ menu</strong> in the top-right corner and tap
					<strong class="text-white">Sound On</strong> or <strong class="text-white">Sound Off</strong>.
					The button shows your current state and changes color — <span class="text-amber-400 font-semibold">amber</span>
					when sound is on, gray when muted.
				</p>

				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Turn Notifications</h3>
				<p class="text-sm leading-relaxed">
					When it becomes your turn a large <span class="font-semibold text-amber-300">IT'S YOUR TURN!</span>
					banner slides down from the top. When you are one step away, a
					<span class="font-semibold text-blue-300">YOU'RE UP NEXT!</span> banner appears instead.
					Tap either banner to dismiss it early. On mobile, your device will vibrate briefly when your
					turn arrives (if supported).
				</p>
			</section>
			...
			<section id="react">
				...
				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Sending a Reaction</h3>
				<ol class="mb-4 ml-4 list-decimal space-y-1.5 text-sm leading-relaxed">
					...
					<li>A brief <strong class="text-white">Sent!</strong> confirmation appears, then the picker closes</li>
				</ol>
				<p class="text-sm leading-relaxed">
			...
			<section id="dice">
				...
				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Opening the Roller</h3>
				<p class="mb-4 text-sm leading-relaxed">
					Open the <strong class="text-amber-300">☰ menu</strong> and tap <strong class="text-white">Dice Roller</strong>.
				</p>

				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Rolling Dice</h3>
				<ol class="mb-4 ml-4 list-decimal space-y-1.5 text-sm leading-relaxed">
					<li>Select your <strong class="text-white">die type</strong> — d4, d6, d8, d10, d12, d20, or d100 (percentile)</li>
					<li>Adjust the <strong class="text-white">quantity</strong> (how many dice, 1–99)</li>
					<li>Set a <strong class="text-white">modifier</strong> (−99 to +99, for ability scores and bonuses)</li>
					<li>Tap <strong class="text-white">Roll</strong></li>
				</ol>
				<p class="mb-4 text-sm leading-relaxed">
					Individual die results are shown in boxes. A <span class="font-semibold text-amber-300">nat-20</span>
					highlights in gold and a <span class="font-semibold text-red-400">nat-1</span> in red (d20 only).
					The <strong class="text-white">Total</strong> accounts for your modifier. Tap
				...
				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Disabling Virtual Dice</h3>
				<p class="text-sm leading-relaxed">
					Prefer to use physical dice and just track results? Check <strong class="text-white">Disable virtual dice</strong>
					at the bottom of the roller. With this on, results are calculated instantly (no animation)
					and you can use the roller as a pure math tracker. This setting is saved in your browser.
				</p>
			</section>
			...
			<section id="message-dm">
				...
				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Sending a Message</h3>
				<ol class="mb-4 ml-4 list-decimal space-y-1.5 text-sm leading-relaxed">
					<li>Open the <strong class="text-amber-300">☰ menu</strong></li>
				...
				<p class="mb-4 text-sm leading-relaxed">
					Messages appear in the DM's <strong class="text-white">Player Messages</strong> inbox on
					the dashboard. The DM sees your name alongside the message and can reply directly back
					to you or compose a new message targeting any player.
				</p>
				<p class="text-sm leading-relaxed">
					<strong class="text-white">Note:</strong> Only players who clicked
					<strong class="text-white">Join Session</strong> can send messages (guests who skipped
					the join step cannot, as they have no identity in the session).
				</p>
			</section>
			...
			<section id="initiative">
				...
				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Submitting Your Roll</h3>
				<ol class="mb-4 ml-4 list-decimal space-y-1.5 text-sm leading-relaxed">
					<li>Open the <strong class="text-amber-300">☰ menu</strong></li>
			...
			<section id="notes">
				...
				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Opening Notes</h3>
				<p class="mb-4 text-sm leading-relaxed">
				...
				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Writing Notes</h3>
				<p class="mb-4 text-sm leading-relaxed">
					Notes are organized by <strong class="text-white">date</strong>. Each day gets its own
					entry that you can freely edit. Changes are saved automatically after a short pause —
					no save button needed.
				</p>

				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Searching Notes</h3>
				<p class="mb-4 text-sm leading-relaxed">
					Use the search bar at the top of the notes panel to filter entries by keyword.
					Matching entries are highlighted in the list.
				</p>

				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Exporting to PDF</h3>
				<p class="text-sm leading-relaxed">
					Each note has a <strong class="text-white">download</strong> icon to export that single
					entry as a PDF. There is also an <strong class="text-white">Export All</strong> button to
					download every note as a single combined PDF — useful for printing a campaign journal at
			...
			<section id="dm-messages">
				...
				<p class="mb-4 text-sm leading-relaxed">
					...
					dashboard. When a message arrives, a <span class="font-semibold text-purple-400">purple toast notification</span>
					slides up from the bottom of your screen and your device will vibrate briefly.
				</p>

				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Unread Badge</h3>
				<p class="mb-4 text-sm leading-relaxed">
				...
				<h3 class="mt-5 mb-2 text-sm font-bold tracking-widest text-gray-200 uppercase">Reading Messages</h3>
				<ol class="mb-4 ml-4 list-decimal space-y-1.5 text-sm leading-relaxed">
					<li>Open the <strong class="text-amber-300">☰ menu</strong></li>
					<li>Tap <strong class="text-white">DM Messages</strong> — the unread count resets to zero</li>
					<li>Messages appear newest-first, showing the sender, recipient, date, time, and text</li>
				</ol>
				<p class="text-sm leading-relaxed">
					Tap <strong class="text-white">Clear all</strong> in the message inbox to wipe all stored
					messages from your screen. This only clears them from your local view — the DM's sent
